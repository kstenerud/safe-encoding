...
#ifndef SAFE64_PUBLIC
    #if defined _WIN32 || defined __CYGWIN__
        #define SAFE64_PUBLIC __declspec(dllimport)
    #else
        #define SAFE64_PUBLIC
    #endif
#endif
 ...
 */
SAFE64_PUBLIC const char* safe64_version(void);
 ...
 */
SAFE64_PUBLIC int64_t safe64_get_decoded_length(int64_t encoded_length);
 ...
 */
SAFE64_PUBLIC int64_t safe64_decode(const uint8_t* src_buffer,
 ...
 * @return the number of bytes written, or a status code.
 */
SAFE64_PUBLIC int64_t safe64l_decode(const uint8_t* src_buffer,
                                     int64_t src_length,
                                     uint8_t* dst_buffer,
                                     int64_t dst_length);
 ...
 */
SAFE64_PUBLIC int64_t safe64_get_encoded_length(int64_t decoded_length,
 ...
 * @return the number of bytes written, or a status code.
 */
SAFE64_PUBLIC int64_t safe64_encode(const uint8_t* src_buffer,
                                    int64_t src_buffer_length,
                                    uint8_t* dst_buffer,
                                    int64_t dst_buffer_length);
 ...
 * @return the number of bytes written, or a status code.
 */
SAFE64_PUBLIC int64_t safe64l_encode(const uint8_t* src_buffer,
                                     int64_t src_buffer_length,
                                     uint8_t* dst_buffer,
                                     int64_t dst_buffer_length);
 ...
 */
SAFE64_PUBLIC int64_t safe64_read_length_field(const uint8_t* buffer,
 ...
 */
SAFE64_PUBLIC safe64_status safe64_decode_feed(const uint8_t** src_buffer_ptr,
                                               int64_t src_length,
 ...
 */
SAFE64_PUBLIC int64_t safe64_write_length_field(int64_t length,
                                                uint8_t* dst_buffer,
                                                int64_t dst_buffer_length);
 ...
 * @return Status code indicating the result of the operation.
 */
SAFE64_PUBLIC safe64_status safe64_encode_feed(const uint8_t** src_buffer_ptr,
                                               int64_t src_length,
                                               uint8_t** dst_buffer_ptr,
                                               int64_t dst_length,
                                               bool is_end_of_data);
