...
TEST_ENCODE_DECODE(_2_bytes, "$s2",     {0x2e, 0x99})
TEST_ENCODE_DECODE(_3_bytes, "L!6t",    {0xf2, 0x34, 0x56})
TEST_ENCODE_DECODE(_4_bytes, "!KWGj;",  {0x4a, 0x88, 0xbc, 0xd1})
TEST_ENCODE_DECODE(_5_bytes, "+7oG4E=", {0xff, 0x71, 0xdd, 0x3a, 0x92})

TEST_ENCODE_DECODE_WITH_LENGTH(_1_byte,  "$)$",      {0xf1})
TEST_ENCODE_DECODE_WITH_LENGTH(_2_bytes, "($s2",     {0x2e, 0x99})
TEST_ENCODE_DECODE_WITH_LENGTH(_3_bytes, ")L!6t",    {0xf2, 0x34, 0x56})
TEST_ENCODE_DECODE_WITH_LENGTH(_4_bytes, "+!KWGj;",   {0x4a, 0x88, 0xbc, 0xd1})
TEST_ENCODE_DECODE_WITH_LENGTH(_5_bytes, ",+7oG4E=", {0xff, 0x71, 0xdd, 0x3a, 0x92})

TEST_DECODE_ERROR(dst_buffer_too_short_4, 4, "+7oG4E=", SAFE80_ERROR_NOT_ENOUGH_ROOM)
TEST_DECODE_ERROR(dst_buffer_too_short_3, 3, "+7oG4E=", SAFE80_ERROR_NOT_ENOUGH_ROOM)
TEST_DECODE_ERROR(dst_buffer_too_short_2, 2, "+7oG4E=", SAFE80_ERROR_NOT_ENOUGH_ROOM)
TEST_DECODE_ERROR(dst_buffer_too_short_1, 1, "+7oG4E=", SAFE80_ERROR_NOT_ENOUGH_ROOM)

TEST_DECODE_ERROR(invalid_0, 100, ">+7oG4E=", SAFE80_ERROR_INVALID_SOURCE_DATA)
TEST_DECODE_ERROR(invalid_1, 100, "+>7oG4E=", SAFE80_ERROR_INVALID_SOURCE_DATA)
TEST_DECODE_ERROR(invalid_2, 100, "+7>oG4E=", SAFE80_ERROR_INVALID_SOURCE_DATA)
TEST_DECODE_ERROR(invalid_3, 100, "+7o>G4E=", SAFE80_ERROR_INVALID_SOURCE_DATA)
TEST_DECODE_ERROR(invalid_4, 100, "+7oG>4E=", SAFE80_ERROR_INVALID_SOURCE_DATA)
TEST_DECODE_ERROR(invalid_5, 100, "+7oG4>E=", SAFE80_ERROR_INVALID_SOURCE_DATA)
TEST_DECODE_ERROR(invalid_6, 100, "+7oG4E>=", SAFE80_ERROR_INVALID_SOURCE_DATA)
TEST_DECODE_ERROR(invalid_7, 100, "+7oG4E=>", SAFE80_ERROR_INVALID_SOURCE_DATA)

TEST_DECODE(space_0, " +7oG4E=", {0xff, 0x71, 0xdd, 0x3a, 0x92})
TEST_DECODE(space_1, "+ 7oG4E=", {0xff, 0x71, 0xdd, 0x3a, 0x92})
TEST_DECODE(space_2, "+7 oG4E=", {0xff, 0x71, 0xdd, 0x3a, 0x92})
TEST_DECODE(space_3, "+7o G4E=", {0xff, 0x71, 0xdd, 0x3a, 0x92})
TEST_DECODE(space_4, "+7oG 4E=", {0xff, 0x71, 0xdd, 0x3a, 0x92})
TEST_DECODE(space_5, "+7oG4 E=", {0xff, 0x71, 0xdd, 0x3a, 0x92})
TEST_DECODE(space_6, "+7oG4E =", {0xff, 0x71, 0xdd, 0x3a, 0x92})
TEST_DECODE(space_7, "+7oG4E= ", {0xff, 0x71, 0xdd, 0x3a, 0x92})

TEST_DECODE(lots_of_whitespace, "+\t\t7\r\n\n o   G4\t \t\tE=", {0xff, 0x71, 0xdd, 0x3a, 0x92})
...
TEST_DECODE_WITH_LENGTH_STATUS(_longer_than_end, "N++7oG4E=", -1, SAFE80_ERROR_TRUNCATED_DATA)
...
TEST_DECODE_WITH_LENGTH_STATUS(_whitespace, " N $  2b !\n^f\t\t__]K$k{8B@]9+v2hInzMsV{}`Hbiz0u]I@Asv", -1, 33)
...
TEST_ENCODE_DECODE(example_1, ",4@yggKKdSTm[V+^oj", {0x39, 0x12, 0x82, 0xe1, 0x81, 0x39, 0xd9, 0x8b, 0x39, 0x4c, 0x63, 0x9d, 0x04, 0x8c})
TEST_ENCODE_DECODE(example_2, "pF2U]^CJPSTQXo0KB[!", {0xe6, 0x12, 0xa6, 0x9f, 0xf8, 0x38, 0x6d, 0x7b, 0x01, 0x99, 0x3e, 0x6c, 0x53, 0x7b, 0x60})
TEST_ENCODE_DECODE(example_3, "2imlk)-I2HaWeWjS}}F(f", {0x21, 0xd1, 0x7d, 0x3f, 0x21, 0xc1, 0x88, 0x99, 0x71, 0x45, 0x96, 0xad, 0xcc, 0x96, 0x79, 0xd8})
TEST_DECODE_LENGTH(example_1,    "$",      1, 1)
TEST_DECODE_LENGTH(example_31,   "L",     31, 1)
TEST_DECODE_LENGTH(example_32,   "N!",    32, 2)
TEST_DECODE_LENGTH(example_2000, "Nl9", 2000, 3)
TEST_ENCODE_DECODE_WITH_LENGTH(example_w_length, "N$2b!^f__]K$k{8B@]9+v2hInzMsV{}`Hbiz0u]I@Asv", {0x21, 0x7b, 0x01, 0x99, 0x3e, 0xd1, 0x7d, 0x3f, 0x21, 0x8b, 0x39, 0x4c, 0x63, 0xc1, 0x88, 0x21, 0xc1, 0x88, 0x99, 0x71, 0xa6, 0x9f, 0xf8, 0x45, 0x96, 0xe1, 0x81, 0x39, 0xad, 0xcc, 0x96, 0x79, 0xd8})
